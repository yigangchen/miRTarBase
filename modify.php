...
<html>
    ...
    mysql_select_db("training",$con);
        $sql = "select * from mirtarbase_training WHERE ID = '$_GET[id]'";
...
?>
	...
	<div><label for="pmid">PMID <em>*</em></label> <input id="pmid" type="text" name="pmid" value= <?php echo $pmid?> /></div>
    </fieldset>
  ...
  <script>
  $(function(){
  $("#species_mirna option[value=<?php echo $Species_miRNA?>]").attr("selected",true)
});
  </script>
  ...
  <script>
  $(function(){
  $("#species_target option[value=<?php echo $Species_target?>]").attr("selected",true)
});
  </script>
	...
	<div>
        ...
        <input id="mirna" name="mirna" type="text" size="30" value = <?php echo $miRNA?> /><a href='http://www.mirbase.org/' target='_new'><img src="http://www.mirbase.org/images/mirbase-logo-blue-web.png" height=30></a>
        </div>
        <div>
        <label>Official miRNA name</label>
        <input id='official_mirna_name' type='text' name='official_mirna_name' value = <?php echo $official_miRNA_name?> />
        </div>
        <div>
        <label>Mature miRNA accession</label>
        <input id='mature_mirna_accession' type='text' name='mature_mirna_accession' value = <?php echo $mature_miRNA_accession?> />
        </div>
        <div>
        <label>Mature miRNA Sequence </label> 
        5'<input id='mature_mirna_sequence_1' type='text' name='mature_mirna_sequence_1'  SIZE='40' value = <?php echo $mature_miRNA_sequence_1?> />3'
        </div>
        <div>
        3'<input id='mature_mirna_sequence_2' type='text' name='mature_mirna_sequence_2'  SIZE='40' value = <?php echo $mature_miRNA_sequence_2?> />5'
        </div>
        <div>
        <label for="gene_symbol">Gene Symbol (Target) <em>*</em></label> 
        <input id="gene_symbol" name="gene_symbol" type="text" size="30" value = <?php echo $gene_symbol?> />
        </div>
        <div>
        <label>Official Gene Symbol</label>
        <input id="official_gene_symbol" name="official_gene_symbol" type="text" size="30" value = <?php echo $official_gene_symbol?> />
        </div>
        <div>
        <label>Entrez Gene ID</label>
        <input id="entrez_gene_id" name="entrez_gene_id" type="text" size="30" value = <?php echo $entrez_gene_id?> />
        </div>

        <div>
        <label for="cell_line"> Cell Line<em>*</em></label>
        <input id="cell_line" name="cell_line" type="text" size="80" value = <?php echo $cell_line?> /> (如果不確定cell line的物種，可以查詢CLDB)<a href="http://bioinformatics.istge.it/hypercldb/search.html"  target='_new'><img src='http://bioinformatics.istge.it/hypercldb/tab3.png' height=30></a>
        </div>
        <script>
        
        $(function(){
          $("input[type='radio'][value=<?php echo $loc?>]").attr("checked", "checked")
        });
      
        </script>
        <div class="controlset">
	  <span class="label">Location<em>*</em></span>
	  <input id = "loc" name="loc"  value="3UTR" type="radio" /> <label for="loc">3'UTR</label>
  	<input id = "loc" name="loc"  value="CDS" type="radio" /> <label for="loc">CDS</label>
  	<input id = "loc" name="loc"  value="5UTR" type="radio" /> <label for="loc">5'UTR</label>
	  <input id = "loc" name="loc"  value="NCR" type="radio" /> <label for="loc">NCR (Non-Coding Region)</label>
	  <input id = "loc" name="loc"  value="3LTR" type="radio" /> <label for="loc">3'LTR</label>
	  <input id = "loc" name="loc"  value="Unknown" type="radio" /> <label for="loc">Unknown</label>
	</div>
	<div>
	...
	<div>
        ...
        <textarea name="original_description" cols="60" rows="10"  ><?php echo $original_description?></textarea>
    </div>
	<div>
        <label for="note"> Note</label>
        <textarea name="note" cols="60" rows="5" ><?php echo $note?></textarea>
    </div>
    <script>
        
        $(function(){
          $("input[type='checkbox'][value=<?php echo $tf?>]").attr("checked", "checked")
        });
	...
	<div>
	  ...
	  <input id="disease" type="text" name="disease" size="80" value = <?php echo $disease?> />
	</div>
  <script>
        
        $(function(){
          $("input[type='radio'][value=<?php echo $relationship_type?>]").attr("checked", "checked")
        });
  ...
  <script>
        ...
        $(function(){
          $("input[type='radio'][value=<?php echo $expression_pattern_of_mirna?>]").attr("checked", "checked")
        });
  ...
  <div>
	  ...
	  <textarea name="dis_desc" cols="60" rows="10" ><?php echo $description_of_mirna_disease_relationship?></textarea>
	</div>
    </fieldset>
